...
googletag.cmd.push(function() {
    ...
    (window.googletag, window.pbjs, {
        definitons: {
            inreedvid13Slot: {
                adUnitPath: "/21665095471/specktra_top_1",
                size: [
                    [970, 90],
                    [970, 250],
                    [728, 90],
            ...
            inreedvid9Slot: {
                adUnitPath: "/21665095471/specktra_mrec_1",
                size: [
                    [300, 600],
                    [300, 250],
                    [250, 250],
                ...
                sizeMapping: "mappingmenuslot",
                timeout: site_config.refresh_rate,
            },
            inreedvid5Slot: {
                adUnitPath: "/21665095471/specktra_halfpage",
                size: [
                    [300, 600],
                    [300, 250],
                    [250, 250],
            ...
            inreedvid8Slot: {
                adUnitPath: "/21665095471/specktra_threads_leaderboard_1",
                size: [
                    [728, 90],
                    [300, 250],
                    [250, 250],
            ...
            inreedvid4Slot: {
                adUnitPath: "/21665095471/specktra_threads_leaderboard_2",
                size: [
                    [728, 90],
                    [300, 250],
                    [250, 250],
            ...
            inreedvid7Slot: {
                adUnitPath: "/21665095471/specktra_threads_leaderboard_4",
                size: [
                    [970, 250],
                    [970, 90],
                    [728, 90],
                ...
                sizeMapping: "mappingbottom2slot",
                timeout: site_config.refresh_rate,
            },
            inreedvid10Slot: {
                adUnitPath: "/21665095471/specktra_footer_1",
                size: [
                    [970, 250],
                    [970, 90],
                    [728, 90],
            ...
            inreedvid6Slot: {
                adUnitPath: "/21665095471/specktra_footer_2",
                size: [
                    [970, 90],
                    [728, 90],
                    [468, 60],
