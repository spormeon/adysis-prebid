...
window.addEventListener('DOMContentLoaded',function(){
    document.querySelector('.richcontent p:nth-child(2)').insertAdjacentHTML('afterbegin','<br><div class="ad-reporter-ahytrfg35423"><div id="advertisement" style="border: 2px solid black; background-color: blue;">Advertisement</div><div id="inreedvidSlot"></div></div><br>');
    document.querySelector('.richcontent p:nth-child(6)').insertAdjacentHTML('afterbegin','<br><div class="ad-reporter-ahytrfg35423"><div id="advertisement">Advertisement</div><div id="inreedvid1Slot"></div></div><br>');
