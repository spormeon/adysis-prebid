    ...
    adyjs.setConfig({
     ...
     consentManagement: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*200, allowAuctionWithoutConsent: true },
      ...
      s2sConfig: {
        ...
        enabled: true,
        bidders: ['sovrn','somoaudience','rhythmone','pulsepoint','unruly','rubicon','ix','sharethrough','openx'],
...
definitons: {
    ...
    sizeMappings: {
     ...
     [[1024, 768],[[1,1],[550,310],[728,90],[300,250],[250,250],[468,60],[320,50],[336,280],[580,400],[320,100],'fluid']],
