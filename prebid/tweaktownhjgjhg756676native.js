     ...
     consentManagement: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true },
      ...
      // enableOverride: true // publisher will call `pbjs.triggerUserSyncs()'
       ...
       sizeConfig: [
         ...
         { mediaQuery: '(min-width: 500px) and (max-width: 768px)', sizesSupported: [[550, 310], [580, 400], [728, 90],  [468, 60], [320, 50], [320, 100], [336, 280], [300, 250], [250, 250], [1, 1]], labels: ['tablet'] },
