    ...
    adyjs.setConfig({
     ...
     consentManagement: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true },
      ...
      // enableOverride: true // publisher will call `pbjs.triggerUserSyncs()'
       ...
       sizeConfig: [
         { mediaQuery: '(min-width: 769px)', 'sizesSupported': [[580, 400],[550, 310], [728, 90], [468, 60], [336, 280], [320, 100], [320, 50], [300, 250], [250, 250], [1, 1], [0, 0]], 'labels': ['desktop'] },
...
definitons: {
    ...
    sizeMappings: {
     ...
     [[1024, 768],[[1,1],[550,310],[728,90],[300,250],[250,250],[468,60],[320,50],[336,280],[580,400],[320,100],[0,0]]],
