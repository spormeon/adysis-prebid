          ...
          //ASSERTIVE ANALYTICS SETTINGS - Version: 1.4.0
            ...
            var adUnits = [
            	//new ad unit block
            	{
            	 code: 'inreedvidSlot',
            	 mediaTypes: {
            		 banner: { sizes: [[970, 250], [970, 90], [728, 90], [300, 250], [250, 250], [468, 60], [320, 50]] }, 
...
$(document).ready(function(){
   $('<div class="ad-reporter-ahytrfg35423"><div class="advertisement">Advertisement</div><div id="inreedvidSlot"></div></div><br>').insertAfter('.body p:nth-child(2)');
   $('<div class="ad-reporter-ahytrfg35423"><div class="advertisement">Advertisement</div><div id="inreedvid1Slot"></div></div><br>').insertAfter('.body p:nth-child(6)');
   $('<div class="ad-reporter-ahytrfg35423"><div class="advertisement">Advertisement</div><div id="inreedvid2Slot"></div></div><br>').insertAfter('.body p:nth-child(10)');
   $('<div class="ad-reporter-ahytrfg35423"><div class="advertisement">Advertisement</div><div id="inreedvid3Slot"></div></div><br>').insertAfter('.body p:nth-child(18)'); 
   $('<div class="ad-reporter-ahytrfg35423"><div id="skinSlot"></div></div>').insertAfter('#header');
...
googletag.pubads().addEventListener("slotVisibilityChanged", function(e) {
    if (e.inViewPercentage >= 50) {    e.slot["inview"] = 1; } else { e.slot["inview"] = 0; }
})
function CheckAds(adslotv,nor){
        if (document.hidden === false && document.hasFocus() === true) {
            if (adslotv["inview"] == 1) {
            adslotv["viewCounter"] += 1;
            var ab = adslotv["w_bid"]=="appnexus"?1:0
            var ac = adslotv["advID"]=="76502905"?1:0
            if (ab == 1 && ac != 1){var sec = 60}else{var sec = 30}
            if (nor == 1 && ac == 1) {var cancel = 1}else{var cancel = 0}
                if (adslotv["viewCounter"] == sec && adslotv["RefreshCounter"] <= 9 && cancel != 1) {
            refreshBidz(adslotv);
                }
            }
        }
...
if ( AdSlots[0]["Viewable"] == 1) {
 CheckAds(AdSlots[0],1);
}
if ( AdSlots[1]["Viewable"] == 1) {
 CheckAds(AdSlots[1],1);
}
if ( AdSlots[2]["Viewable"] == 1) {
 CheckAds(AdSlots[2],1);
}                                            
 }, 1000);
});
