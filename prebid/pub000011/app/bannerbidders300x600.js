...
{ bidder: 'sovrn', params: { tagid: '590978' } }, /* 300x600 */
{ bidder: 'sovrn', params: { tagid: '590977' } }, /* 300x250 */
{ bidder: 'sovrn', params: { tagid: '590973' } }, /* 160x600 */
{ bidder: 'sovrn', params: { tagid: '725048' } }, /* 120x600 */
{ bidder: 'openx', params: { unit: '539995986', delDomain: 'huddler-d.openx.net' } }, /* 300x250 250x250 */
{ bidder: 'openx', params: { unit: '539995988', delDomain: 'huddler-d.openx.net' } }, /* 160x600 300x600 */
{ bidder: 'sharethrough', params: { pkey: "auoW1g6UJHnw8XCAzrbTwfpV", iframe: true } }, /* Sizeless */
{ bidder: 'aol', params: { placement: '5219127', network: '11361.1' } }, /* 300x250 */ 
{ bidder: 'aol', params: { placement: '5219134', network: '11361.1' } }, /* 120x600 */ 
{ bidder: 'aol', params: { placement: '5219135', network: '11361.1' } }, /* 160x600 */ 
{ bidder: 'aol', params: { placement: '5219136', network: '11361.1' } } /* 300x600 */ 
] //./bids
};
