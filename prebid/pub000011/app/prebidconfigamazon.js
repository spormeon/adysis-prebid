...
pbjs.que.push(function() {
    ...
    pbjs.bidderSettings = {
    		...
    		districtm:   { bidCpmAdjustment : function(bidCpm){ if(bidCpm < FLOOR_PRICE){ return 0;}return bidCpm * 0.85; } },
    		districtmDMX:   { bidCpmAdjustment : function(bidCpm){ if(bidCpm < FLOOR_PRICE){ return 0;}return bidCpm * 0/85; } },
    		emx_digital:   { bidCpmAdjustment : function(bidCpm){ if(bidCpm < FLOOR_PRICE){ return 0;}return bidCpm * 0/80; } },
    		aol:   { bidCpmAdjustment : function(bidCpm){ if(bidCpm < FLOOR_PRICE){ return 0;}return bidCpm * 0.80; } },
      ...
      // enableOverride: true // publisher will call `pbjs.triggerUserSyncs()'
       ...
       //currency: { 'adServerCurrency': "GBP", 'granularityMultiplier': 1, 'conversionRateFile': 'https://cdn.jsdelivr.net/gh/prebid/currency-file@1/latest.json', },
        sizeConfig: [
            ...
            { mediaQuery: '(min-width: 769px)', sizesSupported: [[728,90],[468,60],[320,50],[320,100]], labels: [ 'desktopleader'] },
            { mediaQuery: '(min-width: 769px)', sizesSupported: [[970, 250],[970,90],[728,90],[468,60],[320,50]], labels: [ 'desktopfooter'] },
            { mediaQuery: '(min-width: 769px)', sizesSupported: [[300,250],[250,250],[468,60],[320,50],[336,280],[580,400],[320,100]], labels: [ 'desktopbottom2'] },
            ...
            { mediaQuery: '(min-width: 500px) and (max-width: 768px)', sizesSupported: [[300,250],[250,250],[468,60],[320,50],[336,280],[580,400],[320,100]], labels: [ 'tabletbottom2'] },
            { mediaQuery: '(min-width: 500px) and (max-width: 768px)', sizesSupported: [[728,90],[468,60],[320,50]], labels: [ 'tabletleader'] },
            { mediaQuery: '(min-width: 500px) and (max-width: 768px)', sizesSupported: [[300,250],[250,250]], labels: [ 'tabletskyscraper'] },
            ...
            { mediaQuery: '(min-width: 1px) and (max-width: 499px)', sizesSupported: [[300,250],[250,250]], labels: [ 'phonescraper'] }
          ]
    });
...
definitons: {
inreedvid13Slot: { adUnitPath: "/21665095471/sm_top_leaderboard_1", size: [[728, 90],[468, 60],[320, 50],[320, 100]], sizeMapping: "mappingleaderslot", timeout: site_config.refresh_rate, },
...
inreedvid6Slot: { adUnitPath: "/21665095471/sm_footer_1", size: [[970, 250],[970, 90],[728, 90],[468, 60],[320, 50],[320, 100]], sizeMapping: "mappingfooterslot", timeout: site_config.refresh_rate, },
},
sizeMappings: {
	...
	mappingfooterslot: [
	[[1024, 768],[[970, 250],[970, 90],[728, 90],[468, 60],[320, 50],[320, 100]]],
	[[768, 500],[[728, 90],[468, 60],[320, 50]]],
	[[1, 1],[[468, 60],[320, 50]]]
	],
	mappingleaderslot: [
	[[1024, 768],[[728, 90],[468, 60],[320, 50],[320, 100]]],
	[[768, 500],[[728, 90],[468, 60],[320, 50]]],
	[[1, 1],[[468, 60],[320, 50]]]
	] 
	}
