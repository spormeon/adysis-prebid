...
require(["lib/gpt_min"], function (gpt) {
require(["lib/bidfilter_min"], function (bidfilter) {
...
require(["app/custombuckets_min"], function (custombuckets) {
require(["app/prebidconfig_min"], function (prebidconfig) {
require(["app/assertivecustom_min"], function (assertivecustom) {
require(["lib/assertive"], function (assertive) {
require(["lib/preconnect_min"], function (preconnect) {	
