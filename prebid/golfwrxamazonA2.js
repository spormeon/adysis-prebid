...
(function() {
    ...
    adyjsEl.async = true;
    adyjsEl.src = "https://adops.adysis.com/prebid2.22.0adyjs.js";
    ...
    adyjs.setConfig({
     ...
     consentManagement: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*200, allowAuctionWithoutConsent: true },
      ...
      s2sConfig: {
        ...
        enabled: true,
        bidders: ['sovrn','somoaudience','districtm','rhythmone','pulsepoint','gamoshi','rubicon','openx','sharethrough','unruly','33across','ix'],
