...
bids: [
{ bidder: 'bidder7', params: { placementId: '11962910', allowSmallerSizes: true, video: { skippable: true, playback_method: ['auto_play_sound_off'] } } }, /* one placementId for all sizes */
...
{ bidder: 'bidder2', params: { placementId: 11937611, allowSmallerSizes: true, video: { skippable: true, playback_method: ['auto_play_sound_off'] } } }, 
{ bidder: 'bidder13', params: { site_id: '118233', mimes: [ 'video/mp4', 'application/javascript' ], maxduration: 30 } },  /* 300x250 */ 
...
//{ bidder: 'beachfront', params: { bidfloor: 0.01, appIds: '11bc5dd5-7421-4dd8-c926-40fa653bec76' } }, /* video for s2s bidding TEST */
...
{ bidder: 'bidder23', params: { placementId: '11962910', allowSmallerSizes: true, video: { skippable: true, playback_method: ['auto_play_sound_off'] } } }, /* one placementId for all sizes */
//{ bidder: 'smartyads', params: { placementId: '11833' } }, /* outstream */
{ bidder: 'bidder15', params: { placementId: '16137883', allowSmallerSizes: true, video: { skippable: true, playback_method: ['auto_play_sound_off'] } } },
...
{ bidder: 'bidder21', params: { tagid: '77460', video: { skippable: true, playback_method: ['auto_play_sound_off'] } } }, /* outstream */
{ bidder: 'bidder28', params: { placementId: '16714331', allowSmallerSizes: true, video: { skippable: true, playback_method: ['auto_play_sound_off'] } } },  /* video placement */
{ bidder: 'bidder22', params: { zoneId: "oER0LEUveIUa2IMZI3uR" } }
] //./bids
};