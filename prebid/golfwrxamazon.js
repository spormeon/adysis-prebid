            ...
            var adUnits = [
            	//new ad unit block
            	{
            	 ...
            	 mediaTypes: {
            		 ...
            		 video:  { context: 'outstream', mimes: ['video/x-flv', 'video/mp4', 'application/x-shockwave-flash', 'application/javascript', 'video/webm'], playerSize: [[550, 310]], minduration: 1,  maxduration: 30, protocols: [2,3], w:640, h:480, protocols: [2,3], playbackmethod: [2],  renderer: { url: 'http://cdn.adnxs.com/renderer/video/ANOutstreamVideo.js', render: function (bid) { ANOutstreamVideo.renderAd({ targetId: bid.adUnitsCode, adResponse: bid.adResponse, }); } } }, 
