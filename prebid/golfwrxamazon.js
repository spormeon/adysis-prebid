            ...
            var adUnits = [
            	//new ad unit block
            	{
            	 ...
            	 mediaTypes: {
            		 ...
            		 video:  { context: 'outstream', rendererUrl: 'http://cdn.adnxs.com/renderer/video/ANOutstreamVideo.js', mimes: ['video/x-flv', 'video/mp4', 'application/x-shockwave-flash', 'application/javascript', 'video/webm'], playerSize: [[550, 310]], minduration: 1,  maxduration: 30, protocols: [2,3], w:640, h:480, protocols: [2,3], playbackmethod: [2] } },  
            		 renderer: { url: 'http://cdn.adnxs.com/renderer/video/ANOutstreamVideo.js', render: function (bid) { ANOutstreamVideo.renderAd({ targetId: bid.adUnitsCode, adResponse: bid.adResponse, }); }   
            	 },
            	bids: [
            	 ...
            	 { bidder: 'appnexus',   params: { placementId: '13232392', video: { skippable: true, rendererUrl: 'http://cdn.adnxs.com/renderer/video/ANOutstreamVideo.js' } } }, /* demo video placement, always returns a vid, only works client side */ 
		  ...
		  "buckets" : [{
            ...
            pbjs.setConfig({
                 ...
                 s2sConfig: {
                     ...
                     enabled: true,
                     bidders: ['sovrn','somoaudience','appnexus'],
                     timeout: 1000,
