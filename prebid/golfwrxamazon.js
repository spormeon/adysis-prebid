          ...
          //example of supplying a custom var from a prev. defined var
            ...
            var adUnits = [
            	...
            	bids: [
            	 ...
            	 { bidder: 'appnexus',   params: { placementId: '13232392', video: { skippable: true, playbackmethod: ['auto_play_sound_off'] } } }, /* demo video placement, always returns a vid, only works client side */ 
