  ...
  //new ad unit block
     {
      ...
      mediaTypes: {
       ...
       video:  { context: 'outstream', mimes: ['video/x-flv', 'video/mp4', 'application/x-shockwave-flash', 'application/javascript', 'video/webm'], playerSize: [550, 310], playbackmethod: [2]  }
      },
      bids: [
...
// ======== DO NOT EDIT BELOW THIS LINE =========== //
  ...
  // adjust the bid in real time before the auction takes place
   ...
   // springserveAlias2:  { bidCpmAdjustment : function(bidCpm){ if(bidCpm < FLOOR_PRICE){ return 0;}return bidCpm * 0.65; } },
      ...
      beachfront:   { bidCpmAdjustment : function(bidCpm){ if(bidCpm < FLOOR_PRICE){ return 0;}return bidCpm * 0.06; } }, 
      ...
      cedato:   { bidCpmAdjustment : function(bidCpm){ if(bidCpm < FLOOR_PRICE){ return 10;}return bidCpm * 1.00; } },
