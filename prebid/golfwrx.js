            ...
            var adUnits = [
            	//new ad unit block
            	{
            	 ...
            	 mediaTypes: {
            	     ...
            	     video:  { context: 'outstream', playerSize: [300, 250], mimes: ['video/x-flv', 'video/mp4', 'application/x-shockwave-flash', 'application/javascript', "video/webm"], playbackmethod: [2] }
            	 },
            	...
            	bids: [
            	 ...
            	 { bidder: 'viewdeos',      labelAny: ['desktop', 'tablet', 'phone'], params: { supplyPartnerId: '1275', rendererUrl: 'https://s.viewdeos.io/video/latest/renderer.js' } } /* oustream  */
