     ...
     consentManagement: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400, allowAuctionWithoutConsent: true },
      ...
      // enableOverride: true // publisher will call `pbjs.triggerUserSyncs()'
       ...
       sizeConfig: [
         ...
         { mediaQuery: '(min-width: 769px)', sizesSupported: [[970,90],[970,250],[728,90],[468,60],[320,50],[300,250],[250,250],[320,100],[336,280],[580,400],[550,310],[1,1]], labels: [ 'desktopleader'] },
