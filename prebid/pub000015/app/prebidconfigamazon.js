...
pbjs.que.push(function() {
    ...
    pbjs.setConfig({
     ...
     consentManagement: { gdpr: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*2, allowAuctionWithoutConsent: true }, usp: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*400 } },
...
googletag.cmd.push(function() {
    (function(googletag, pbjs, config) {
        ...
        googletag.pubads().addEventListener( LAZYLOADSTYLE, function(event) {
