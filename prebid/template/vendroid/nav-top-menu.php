...
<!-- Specific Page Data -->
<?php $title = 'Top Navigation Mega Menu Link - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, Mega Menu, Admin Template, Elegant HTML Theme, Vendroid'; ?>
<?php $description = 'Top Navigation Mega Menu Link - Responsive Admin HTML Template'; ?>
<?php $page = 'nav';   // To set active on the same id of primary menu ?>

<?php
	 // Specific Configuration
	 $header = 'header-2';   // header with menu link
?>
<!-- End of Data -->
...
<div class="content">
  <div class="container">
    ...
    <div class="vd_content-wrapper">
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li><a href="nav-top-search.php">Top Navigation</a> </li >
                <li class="active">Top Mega Menu Link</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Top Mega Menu Link</h1>
              <small class="subtitle">Top Navigation with Mega Menu Link</small> </div>
          </div>
          <!-- vd_title-section -->
	 ...
	 // Specific Configuration
	 $header = 'header-2';   // header with mega menu link 
     		</pre>
          </div>
          <!-- .vd_content-section --> 
