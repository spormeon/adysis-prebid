...
<!-- Specific Page Data -->
<?php $title = 'Navigation No Tab - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, All Purpose Admin Template, Vendroid'; ?>
<?php $description = 'Navigation No Tab - Responsive Admin HTML Template'; ?>
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">No Tab Side Navigation</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>No Tab Side Navigation</h1>
              <small class="subtitle">Side Navigation without Tab Menu</small> </div>
          </div>
          <!-- vd_title-section -->
