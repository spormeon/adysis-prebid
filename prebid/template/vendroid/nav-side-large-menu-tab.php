...
<div class="content">
  <div class="container">
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Menu With Tab Menu Content</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Menu With Tab Menu Content</h1>
              <small class="subtitle">Default Menu Navigation</small> </div>
          </div>
          <!-- vd_title-section -->
	...
	$navbar_left_config = 1;
	$navbar_left = 'navbar-tabs-menu';
