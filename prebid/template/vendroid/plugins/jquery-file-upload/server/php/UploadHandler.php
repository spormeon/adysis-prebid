...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'povd_max_size' => 'The uploaded file exceeds the povd_max_size directive in php.ini',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'accept_file_types' => '/.+$/i',
            // The php.ini settings upload_max_filesize and povd_max_size
    ...
    protected function initialize() {
        switch ($this->get_server_var('REQUEvd_METHOD')) {
            case 'OPTIONS':
            case 'HEAD':
                $this->head();
                break;
    ...
    protected function validate($uploaded_file, $file, $error, $index) {
        ...
        $povd_max_size = $this->get_config_bytes(ini_get('povd_max_size'));
        if ($povd_max_size && ($content_length > $povd_max_size)) {
            $file->error = $this->get_error_message('povd_max_size');
            return false;
        }
    ...
    protected function gd_create_scaled_image($file_name, $version, $options) {
        ...
        if (empty($options['crop'])) {
            ...
            $dvd_x = 0 - ($new_width - $max_width) / 2;
            $dvd_y = 0 - ($new_height - $max_height) / 2;
