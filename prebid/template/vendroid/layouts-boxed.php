...
<!-- Specific Page Data -->
<?php $title = 'Layout Boxed HTML Template - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, All Purpose Admin Template, Vendroid'; ?>
<?php $description = 'Layout Boxed - Responsive Admin HTML Template'; ?>
      ...
      <div class="vd_container ">
        <div class="vd_content  clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Layout Boxed</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Layout Boxed</h1>
              <small class="subtitle">Layouts boxed style in the middle</small> </div>
          </div>
          <!-- vd_title-section -->
...
$remove_header = 0; // Remove Header Toggle Button, 1 = show, 0 = hide
fullscreen = 0; // Full Screen Toggle Button, 1 = show, 0 = hide
$boxedtofull = 1; // Boxed to Full Layout Toggle Button, 1 = show, 0 = hide	</pre>
