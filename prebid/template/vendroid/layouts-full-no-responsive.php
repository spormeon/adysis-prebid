      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Layout Full No Responsive</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Layout Full No Responsive</h1>
              <small class="subtitle">Full Width Layout with no responsive features</small> </div>
          </div>
          <!-- vd_title-section -->
