      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Blog Small List</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Blog Small List</h1>
              <small class="subtitle">List with large image on left suited for blog with small rectangle picture.</small> </div>
          </div>
              ...
              <div class="col-xs-12">
                <div class="panel widget light-widget">
                  ...
                  <div class="panel-body">
                    ...
                    <p> Using our "content-list" combination with "content-blog-small" class you can easily create a list with responsive effect under 480px screen.</p>
                  </div>
                </div>
                <!-- Panel Widget --> 
              </div>
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="panel widget light-widget panel-bd-top">
                  <div class="panel-heading no-title"> </div>
                  <div class="panel-body">
                    <h3 class="mgtp--5"> Example Blog Small List</h3>
                    <div class="content-list content-blog-small">
                      <ul class="list-wrapper">
                        ...
                        <li>
                          <div class="menu-icon"> <img alt="example image" src="img/blog/02-square-200.jpg"> </div>
                          <div class="menu-text">
                        ...
                        <li>
                          <div class="menu-icon"> <img alt="example image" src="img/blog/03-square-200.jpg"> </div>
                          <div class="menu-text">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="content-list content-image">
                      <ul class="list-wrapper no-bd-btm">
                        ...
                        <li> <a href="#"> <div class="menu-icon"><img src="img/blog/03-square.jpg" alt="example image"></div> <div class="menu-text pd-5">
                          <h5 class="mgbt-xs-0">Get What You Want</h5>
                          <div class="menu-info"> <div class="menu-date font-xs">Posted: March 24th, 2014 </div>
                          </div> </div> </a> </li>
                        <li> <a href="#"> <div class="menu-icon"><img src="img/blog/01-square.jpg" alt="example image"></div> <div class="menu-text pd-5">
                          <h5 class="mgbt-xs-0">Excelent in Every Step</h5>
                          <div class="menu-info"> <div class="menu-date font-xs">Posted: November 1st, 2011 </div>
                          </div> </div> </a> </li>
                        <li> <a href="#"> <div class="menu-icon"><img src="img/blog/02-square.jpg" alt="example image"></div> <div class="menu-text pd-5">
                          <h5 class="mgbt-xs-0">True Skill Leads Nowhere</h5>
                          <div class="menu-info"> <div class="menu-date font-xs">Posted: December 10th, 2014 </div>
                          </div> </div> </a> </li>
                      </ul>
                    </div>
                  </div>
