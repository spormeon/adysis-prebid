...
<!-- Specific Page Data -->
<?php $title = 'Maps Vector HTML Template - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, All Purpose Admin Template, Vendroid'; ?>
<?php $description = 'Maps Vector - Responsive Admin HTML Template'; ?>
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Vector Map</h1>
              <small class="subtitle">Use filter button on the right side to filter, more information: <a href="http://jvectormap.com/" rel="nofollow">http://jvectormap.com/</a></small>
          ...
          <div class="vd_content-section pd-0 clearfix">
            <div id="map1" style="height:1000px; width:100%;"></div>
...
<?php include('templates/scripts/maps-vector.tpl.php'); ?>
