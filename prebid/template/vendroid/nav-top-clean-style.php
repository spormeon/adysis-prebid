...
<!-- Specific Page Data -->
<?php $title = 'Top Navigation Clean Style - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, Admin Template, Elegant HTML Theme, Vendroid'; ?>
<?php $description = 'Top Navigation Clean Style - Responsive Admin HTML Template'; ?>
<?php $page = 'nav';   // To set active on the same id of primary menu ?>

<?php
	 // Specific Configuration
	 $header = 'header-4';   // clean style header
?>
<!-- End of Data -->
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Top Clean</h1>
              <small class="subtitle">Top Navigation with Clean Style</small> </div>
          </div>
          <!-- vd_title-section -->
