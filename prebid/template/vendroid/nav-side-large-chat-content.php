...
<!-- Specific Page Data -->
<?php $title = 'Navigation Chat - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, All Purpose Admin Template, Vendroid'; ?>
<?php $description = 'Navigation Chat - Responsive Admin HTML Template'; ?>
...
<?php 
	...
	$navbar_left = 'navbar-chat';  // Navbar Left Chat Content
...
<div class="content">
  <div class="container">
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Large Chat Content</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Large Chat Content</h1>
              <small class="subtitle">Chatting template on side navigation</small> </div>
          </div>
          <!-- vd_title-section -->
    ...
    $navbar_right = 'navbar-tabs-menu';  // Navbar Right Menu with Tabs Menu
    $navbar_right_start_width = 'nav-right-medium';  // Navbar Right Width = Medium
    navbar_right_config = 1;  // Start Navbar Right with Visible</pre>
          </div>
          <!-- .vd_content-section --> 
