...
<!-- Specific Page Data -->
<?php $title = 'Navigation Small Size Profile Tab - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, Admin Template, Elegant HTML Theme, Vendroid'; ?>
<?php $description = 'Navigation Small Size Profile Tab - Responsive Admin HTML Template'; ?>
...
<?php
	 ...
	 $navbar_left = 'navbar-tabs-profile'; // Profile Tab
?>
<!-- End of Data -->
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Small Profile Tab</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Small Profile Tab</h1>
              <small class="subtitle">Small Size Navigation with Profile Tab</small> </div>
          </div>
          <!-- vd_title-section -->
