...
<?php 
    ...
    $header  = 'header-empty';   // Empty Header
	$navbar_left = 'navbar-tabs-profile'; // Profile navbar
	$navbar_left_start_width = 'nav-left-medium'; // Medium Width Nav	
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Layout Medium No Header</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Layout Medium Profile No Header</h1>
              <small class="subtitle">Medium Width Left Profile Navigation without header</small> </div>
          </div>
          <!-- vd_title-section -->
