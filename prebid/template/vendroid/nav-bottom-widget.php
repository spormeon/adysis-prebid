...
<!-- Specific Page Data -->
<?php $title = 'Footer With Chat Widget - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, Mega Menu, Admin Template, Elegant HTML Theme, Vendroid'; ?>
<?php $description = 'Footer With Chat Widget  - Responsive Admin HTML Template'; ?>
<?php $page = 'nav';   // To set active on the same id of primary menu ?>

<?php
	 // Specific Configuration
	 $footer = 'footer-1';   // Footer with Chat Widget
?>
<!-- End of Data -->
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Chat Widget</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
                <h1>Chat Widget</h1>
                <small class="subtitle">Footer with Chat Widget</small>
             </div>   
          </div>
          <!-- vd_title-section -->
