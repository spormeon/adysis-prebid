...
<!-- Specific Page Data -->
<?php $title = 'Top Navigation Search Functionality - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, Mega Menu, Admin Template, Elegant HTML Theme, Vendroid'; ?>
<?php $description = 'Top Navigation Search Functionality - Responsive Admin HTML Template'; ?>
<?php $page = 'nav';   // To set active on the same id of primary menu ?>

<?php
	 // Specific Configuration
	 $header = 'header-1';   // header with search
?>
<!-- End of Data -->
...
<div class="content">
  <div class="container">
    ...
    <div class="vd_content-wrapper">
      <div class="vd_container">
        <div class="vd_content clearfix">
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Top Search</h1>
              <small class="subtitle">Top Navigation with Search Widget</small> </div>
          </div>
          <!-- vd_title-section -->
	 ...
	 // Specific Configuration
	 $header = 'header-1';   // header with search widget
     		</pre>
          </div>
          <!-- .vd_content-section --> 
