...
<!-- Specific Page Data -->
<?php $title = 'UI Elements Panels Draggable - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, Mega Menu, Admin Template, Elegant HTML Theme, Vendroid'; ?>
<?php $description = 'UI Elements Panels Draggable - Responsive Admin HTML Template'; ?>
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Panels Draggable</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Panels Draggable</h1>
              <small class="subtitle">Panel with drag and drop function</small> </div>
          </div>
...
<?php include('templates/scripts/ui-panels-draggable.tpl.php'); ?>
