...
<!-- Specific Page Data -->
<?php $title = 'Navigation Small Size Menu Tab - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, All No Tab - Responsive Admin HTML Template'; ?>
<?php $description = 'Navigation Small Size Menu Tab - Responsive Admin HTML Template'; ?>
...
<?php
	 ...
	 $navbar_left = 'navbar-tabs-menu'; // Menu Tabs
?>
<!-- End of Data -->
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Small Menu Tab</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Small Menu Tab</h1>
              <small class="subtitle">Small Size Navigation with Small Tab</small> </div>
          </div>
          <!-- vd_title-section -->
