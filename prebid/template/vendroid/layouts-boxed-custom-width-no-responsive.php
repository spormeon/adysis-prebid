...
<?php 
	...
	$navbar_left_start_width = 'nav-left-medium'; // Medium Width for Left Navigation
	...
	$width_non_responsive = 960; // Width for middle or boxed layout with non responsive
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Layout Boxed No Responsive</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Layout Boxed No Responsive</h1>
              <small class="subtitle">Boxed Layout with no responsive features</small> </div>
          </div>
          <!-- vd_title-section -->
...
$fullscreen = 0; // Full Screen Toggle Button, 1 = show, 0 = hide
$boxedtofull = 1; // Boxed to Full Layout Toggle Button, 1 = show, 0 = hide	
$width_non_responsive = 960; // Width for middle or boxed layout with non responsive</pre>
			<br/>
            <div class="row">
              <div class="col-sm-6">
