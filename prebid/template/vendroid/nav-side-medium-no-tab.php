...
<!-- Specific Page Data -->
<?php $title = 'Navigation Medium Size No Tab - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, Metro Slider, Elegant HTML5 Theme'; ?>
<?php $description = 'Navigation Medium Size No Tab - Responsive Admin HTML Template'; ?>
...
<?php
	 ...
	 $navbar_left = 'navbar-no-tab'; // No Tab Navigation
?>
<!-- End of Data -->
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Medium No Tab</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Medium No Tab</h1>
              <small class="subtitle">Medium Size Navigation with No Tab</small> </div>
          </div>
          <!-- vd_title-section -->
