...
<!-- Specific Page Data -->
<?php $title = 'Navigation Tabs Tab - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, All Purpose Admin Template, Vendroid'; ?>
<?php $description = 'Navigation Tabs Tab - Responsive Admin HTML Template'; ?>
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Tabs Tab</h1>
              <small class="subtitle">Large Side Navigation with Tabs Tab</small> </div>
          </div>
          <!-- vd_title-section -->
