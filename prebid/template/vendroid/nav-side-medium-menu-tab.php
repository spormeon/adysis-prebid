...
<!-- Specific Page Data -->
<?php $title = 'Navigation Medium Size Menu Tab - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, All Purpose Admin Template, Vendroid'; ?>
<?php $description = 'Navigation Medium Size Tabs Tab - Responsive Admin HTML Template'; ?>
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Medium Menu Tab</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Medium Menu Tab</h1>
              <small class="subtitle">Medium Size Navigation with Menu Tab</small> </div>
          </div>
          <!-- vd_title-section -->
