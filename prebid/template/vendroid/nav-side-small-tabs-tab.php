...
<!-- Specific Page Data -->
<?php $title = 'Navigation Small Size Tabs Tab - Responsive Multipurpose Admin Templates'; ?>
<?php $keywords = 'HTML5 Template, CSS3, Admin Template, Elegant HTML Theme, Vendroid'; ?>
<?php $description = 'Navigation Small Size Tabs Tab - Responsive Admin HTML Template'; ?>
...
<div class="content">
  <div class="container">
    ...
    <div class="vd_content-wrapper">
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header">
              <ul class="breadcrumb">
                ...
                <li class="active">Small Tabs Tab</li>
              </ul>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Small Tabs Tab</h1>
              <small class="subtitle">Small Size Navigation with Tabs Tab</small> </div>
          </div>
          <!-- vd_title-section -->
	 ...
	 // Specific Configuration
	 $navbar_left_start_width = 'nav-left-small';  // Navigation Left Small Size
	 $navbar_left = 'navbar-tabs-tab'; // Tabs Tab Tab   
     		</pre>
          </div>
          <!-- .vd_content-section --> 
