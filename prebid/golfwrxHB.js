...
apstag.fetchBids({
     slots: [{
         ...
         sizes: [[300, 600],[300, 250],[160, 600],[120, 600]] //example: [[300,250], [300,600]]
     },
     {
         ...
         sizes: [[970, 250],[970, 90],[728, 90]] //example: [[728,90]]
     },
     {
         ...
         sizes: [[300, 600],[300, 250],[160, 600],[120, 600]] //example: [[728,90]]
     },
     {
  ...
  (function() {
      ...
      pbjsEl.async = true;
      pbjsEl.src = "https://d3s34vlfe7g7ew.cloudfront.net/prebid_20180413075915.js";
    ...
    pbjs.que.push(function() {
      ...
      pbjs.bidderSettings = { 
           ...
           standard: {
              ...
              { key: "hb_pb",     val: function(bidResponse) { var cpm = (bidResponse.cpm * (gpt_config.latest_gbp_rate || gpt_config.default_gbp_rate));  //converts cpm to GBP, rounds cpm to nearest 0.10 incriment, sets 20 if above 20, sets a rev share value
