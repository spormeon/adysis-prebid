...
$(document).ready(function(){
   ...
   $('<div class="ad-reporter-ahytrfg35423"><div class="advertisement">Advertisement</div><div id="inreedvid1Slot"></div></div><br>').insertAfter('#mvp-content-main p:nth-child(6)');
...
googletag.cmd.push(function() {
    	  ...
    	  inreedvid1Slot = googletag.defineSlot('/1001824/Golfwrx.com-HB/Golfwrx.comHB-Vid-test1', [[300,250],[728,90],[1,1],[640, 480]], 'inreedvid1Slot').addService(googletag.pubads());
...
//START ASSERTIVE ANALYTICS - Version: 1.7.0 + Pixel Tracking + HTML Source Match
!function(){"use strict";var p="1.7",a="https://api.assertcom.de",e="assertive_analytics_",f=e.concat("sessionUUID"),s=e.concat("sessionStart"),d=e.concat("sessionRandom"),v=e.concat("sessionUTM"),h=e.concat("sessionReferrer"),I=w(),U=[],b=[],t=t||localStorage.getItem("assertiveYield")&&-1!==localStorage.getItem("assertiveYield").indexOf("debug")||-1!==l("assertiveYield").indexOf("debug");function w(e){return e?(e^16*Math.random()>>e/4).toString(16):([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,w)}function l(e){return decodeURI(window.location.search.replace(new RegExp("^(?:.*[&\\?]"+escape(e).replace(/[\.\+\*]/g,"\\$&")+"(?:\\=([^&]*))?)?.*$","i"),"$1"))}function y(e){t&&console.log(e)}function S(e,t){var n=JSON.stringify(t),i=encodeURIComponent(n),o=a+"?img=true&entityId="+assertive_entityId+"&event="+e+"&data="+i+"&cb="+Math.round(1e14*Math.random());if(o.length<2e3){(new Image).src=o,y("SENT as img!!!")}else{var r=new XMLHttpRequest;r.open("POST",a,!0),r.setRequestHeader("Content-Type","text/plain"),r.send(n),y("SENT as xhr!!!")}}Array.prototype.find||Object.defineProperty(Array.prototype,"find",{value:function(e){if(null==this)throw new TypeError('"this" is null or not defined');var t=Object(this),n=t.length>>>0;if("function"!=typeof e)throw new TypeError("predicate must be a function");for(var i=arguments[1],o=0;o<n;){var r=t[o];if(e.call(i,r,o,t))return r;o++}},configurable:!0,writable:!0}),function(){if(!localStorage.getItem(s)||Date.now()>localStorage.getItem(s)){localStorage.setItem(f,w()),localStorage.setItem(d,Math.random()),document.referrer?localStorage.setItem(h,document.referrer):localStorage.removeItem(h);var e=["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],t={};for(var n in e){var i=e[n],o=l(i);""!==o&&(t[i]=o)}var r=JSON.stringify(t);r!==JSON.stringify({})?localStorage.setItem(v,r):localStorage.removeItem(v)}localStorage.setItem(s,Date.now()+18e5)}(),-1!==l("assertiveYield").indexOf("check")&&alert("Assertive Yield: Check"),("undefined"==typeof assertive_sampleRate||assertive_sampleRate&&localStorage.getItem(d)<assertive_sampleRate)&&function e(){if(n)return;if("undefined"==typeof googletag||!googletag.pubadsReady)return void setTimeout(e,20);n=!0;var m=null;window.addEventListener("blur",function(){m&&S("click",{impressionUUID:U[m]})});googletag.cmd.push(function(){googletag.pubads().addEventListener("slotRenderEnded",function(e){if(!e.isEmpty){var t=e.slot,n=t.getSlotElementId(),i=t.getAdUnitPath(),o=document.getElementById(n),r=null;if(o){if(pbjs.adUnits.find(function(e){return e.code===n}))r=n;else{if(!pbjs.adUnits.find(function(e){return e.code===i}))return;r=i}var a=o.getElementsByTagName("iframe")[0];a.addEventListener("mouseover",function(){m=n}),a.addEventListener("touchstart",function(){m=n}),a.addEventListener("mouseout",function(){m=null}),a.addEventListener("touchend",function(){m=null});var s=t.getHtml(),d=/pbjs\.renderAd\(document, '(.*)'\)/g.exec(s),l=d?d[1]:t.getTargeting("hb_adid")[0],c=!!d,u=pbjs.getBidResponsesForAdUnitCode(r).bids.find(function(e){return e.adId===l});U[n]=w(),y("Session UUID: "+localStorage.getItem(f)+", PageView UUID: "+I+", Impression UUID: "+U[n]),y("Slot Id: "+n+", AdUnitPath: "+i),u&&y(" - Highest PreBid "+u.cpm+" from "+u.bidderCode+" with id "+l),u||y(" - No PreBids!!!"),y(" - Winner: "+(c?"prebid":"dfp (Direct/AdX/AdSense)")+" with size "+(c?u.width:e.size[0])+"x"+(c?u.height:e.size[1])),y("---------------");var g={version:p,entityId:assertive_entityId,siteUUID:"undefined"!=typeof assertive_siteUUID?assertive_siteUUID:null,sessionUUID:localStorage.getItem(f),pageViewUUID:I,impressionUUID:U[n],slotId:n,adUnitPath:i,highestPreBid:u?u.cpm:0,highestPreBid_partner:u?u.bidderCode:"",buyerId:u&&u.appnexus&&u.appnexus.buyerMemberId?u.appnexus.buyerMemberId:null,creative_width:c?u.width:e.size[0],creative_height:c?u.height:e.size[1],preBidWon:c,timeToRespond:u?u.timeToRespond:null,protocol:window.location.protocol,host:window.location.host,pathname:window.location.pathname,pathname_split:window.location.pathname.split("/").filter(function(e){return e}),referrer:localStorage.getItem(h),utm:localStorage.getItem(v),prebid_timeout:assertive_timeout||null,prebid_version:pbjs.version||null,userState:assertive_userState||null,layout:assertive_layout||null,bps_type:t.getTargeting("ay_bid")[0]||null};b.push(g),S("impression",g)}}}),googletag.pubads().addEventListener("impressionViewable",function(e){var t=e.slot.getSlotElementId();S("activeView",{impressionUUID:U[t]})})})}();var n=!1}();
