		  ...
		  "buckets" : [{
            ...
            pbjs.que.push(function() {
                ...
                pbjs.bidderSettings = { 
                	        ...
                	        teads:             { bidCpmAdjustment : function(bidCpm){ return bidCpm * 0.35; } }, // adjust the bid in real time before the auction takes place
                	       };	
...
googletag.pubads().enableLazyLoad({
    	fetchMarginPercent: 15,  // Fetch slots within 5 viewports.
