            ...
            var adUnits = [
            	//new ad unit block
            	{
            	 ...
            	 mediaTypes: {
            	     ...
            	     video:  { context: 'outstream', playerSize: [640, 480], mimes: ['video/x-flv', 'video/mp4', 'application/x-shockwave-flash', 'application/javascript', "video/webm"], playbackmethod: [2], minduration: 1, maxduration: 30, protocols: [1, 2], w: 1, h: 1, startdelay: 1, placement: 1 },
            	},
            	bids: [
