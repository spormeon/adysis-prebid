            ...
            var adUnits = [
            	...
            	//new ad unit block
            	{
            	 ...
            	 mediaTypes: {
            		 ...
            		 video:  { context: 'outstream', playerSize: [[640,480],[550,310],[640,390],[1,1]], mimes: ["video/x-flv", "video/mp4", "application/x-shockwave-flash", "application/javascript"], },
            	},
            	bids: [
		  ...
		  "buckets" : [{
            ...
            pbjs.que.push(function() {
                ...
                pbjs.bidderSettings = { 
                	        ...
                	        districtm:         { bidCpmAdjustment : function(bidCpm){ return bidCpm * 5.90; } }, // adjust the bid in real time before the auction takes place
                ...
                pbjs.setConfig({
                 ...
                 s2sConfig: {
                     ...
                     enabled: true,
                     bidders: ['somoaudience', 'conversant', 'pulsepoint', 'appnexus', 'districtm'],
                     timeout: 1000,
...
googletag.cmd.push(function() {
    	  inreedvidSlot = googletag.defineSlot('/1001824/Golfwrx.com-HB/Golfwrx.com-HB-Vid-test',  [[300, 250],[728,90],[1,1],[970,250]], 'inreedvidSlot').addService(googletag.pubads());
