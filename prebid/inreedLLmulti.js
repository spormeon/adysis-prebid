...
window.addEventListener('load',function(){
    document.querySelector('#mvp-content-main p:nth-child(2)').insertAdjacentHTML('afterbegin','<div class="ad-reporter-ahytrfg35423">Advertisement<div id="inreedvidSlot"></div><div>');
