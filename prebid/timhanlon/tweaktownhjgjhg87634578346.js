  ...
  //new ad unit block
     {
      ...
      mediaTypes: {
       ...
       native: { image: { sizes: [300, 100], sendId: true }, title: { len: 50 }, sponsoredBy: { required: true }, clickUrl: { required: true, sendId: true } },
    ...
    adyjs.setConfig({
     ...
     consentManagement: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*200, allowAuctionWithoutConsent: true },
      ...
      s2sConfig: {
        ...
        enabled: true,
        bidders: ['sovrn','somoaudience','rhythmone','pulsepoint'],
