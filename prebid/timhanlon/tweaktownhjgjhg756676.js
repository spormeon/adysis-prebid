  ...
  //new ad unit block
     {
      ...
      mediaTypes: {
       ...
       video:  { context: 'outstream', playerSize: [[550, 310]], mimes: ['video/x-flv', 'video/mp4', 'application/x-shockwave-flash', 'application/javascript', "video/webm"], playbackmethod: [2], minduration: 10,  maxduration: 30, protocols: [2,3] }
      },
      bids: [
    ...
    adyjs.setConfig({
     ...
     consentManagement: { cmpApi: 'iab', timeout: PREBID_TIMEOUT*200, allowAuctionWithoutConsent: true },
      ...
      s2sConfig: {
        ...
        enabled: true,
        bidders: ['sovrn','somoaudience','rhythmone','pulsepoint','gamoshi','33across','ix','openx','unruly'],
